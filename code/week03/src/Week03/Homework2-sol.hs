...
mkValidator pay_pkh pos_time () ctx = traceIfFalse "beneficiary's signature missing" signedByBeneficiary &&
  ...
  where
    ...
    signedByBeneficiary = txSignedBy info $ unPaymentPubKeyHash pay_pkh

    deadlineReached :: Bool
    deadlineReached = contains (from pos_time) $ txInfoValidRange info
